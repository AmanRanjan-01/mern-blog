        ...
        <div className='w-full max-w-7xl mx-auto'>
            <div className='grid w-full justify-between sm:flex md:grid-cols-1'>
                ...
                <div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
                    ...
                    <Footer.LinkGroup col>
                        <Footer.Link href='https://github.com/AmanRanjan-01' target='_blank' rel='noopener noreferrer'>
                            Github
                        </Footer.Link>
                        <Footer.Link href='https://www.linkedin.com/in/aman-ranjan-14028b232/' target='_blank' rel='noopener noreferrer'>
                            Linkedin
                        </Footer.Link>
            ...
            <div className='w-full sm:flex sm:items-center sm:justify-between'>
                <Footer.Copyright href='#' by='Aman Ranjan' year={new Date().getFullYear()} />
